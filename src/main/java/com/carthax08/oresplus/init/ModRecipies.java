...
public class ModRecipies
{
    public static void init()
    {
        ...
        GameRegistry.addSmelting(ModBlocks.TITANIUM_ORE, new ItemStack(ModItems.TITANIUM_NUGGET, 1), 1.0f);
        GameRegistry.addSmelting(Items.IRON_INGOT, new ItemStack(ModItems.STEEL_NUGGET, 1), 1.5f);
    }
}
